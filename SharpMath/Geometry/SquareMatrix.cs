...
namespace SharpMath.Geometry
{
    ...
    public class SquareMatrix : Matrix
    {
        ...
        /// <summary>
        ///     Gets a value indicating whether this <see cref="SquareMatrix"/> is singular, or not. If <c>true</c>, this <see cref="SquareMatrix"/> doesn't have an inverse.
        /// </summary>
        ...
        public static SquareMatrix FromMatrix(Matrix matrix)
        {
            if (matrix.ColumnCount != matrix.RowCount)
                throw new InvalidOperationException("Cannot create a square matrix as the row count does not match the column count.");
